...
<?php
   ...
   $user=$_GET['id'];
	...
	$query = mysqli_query($conn, "SELECT * FROM alunos WHERE idaluno= '$user' ") or die("Error: ".mysqli_error($conn));
   ...
   $sql = " DELETE FROM alunos WHERE idaluno = '$user' ";
   
   $pasta=$ob->nome_proprio;
