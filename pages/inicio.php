...
#tt2{
		...
		<button onclick="location.href='inicioVinculo.php'" class="botao"  type="button"  name="button">Vínculo</button>
			...
			<?php
				...
				$result = mysqli_query($connection,"select * from propostas where estado='ativa' order by idpropostas")
			...
			//if($dado['estado'] =='ativa'){		
					...
					<td bgcolor='#E0E0E0'>
					<img  title='Mecatrónica' src='../img/MEC.png' >
					</td>
					...
					<td bgcolor='#E0E0E0'>
					<img  title='Informática de Gestão' src='../img/IG.png' >
					</td>
					...
					<td bgcolor='#E0E0E0'>
					<img  title='Turismo' src='../img/TUR.png' >
					</td>
					...
					<td bgcolor='#E0E0E0'>
					<img  title='Eletrónica Automação e Comando' src='../img/EAC.png' >
					</td>
					...
					<td bgcolor='#E0E0E0'>
					<img  title='Gestão' src='../img/GEST.png' >
					</td>
					...
					<td bgcolor='#E0E0E0'>
					<img  title='Gestão e Programação de Sistemas Infromáticos' src='../img/GPSI.png' >
					</td>
...
<?php
		...
		echo "<script charset='UTF-8'>alert('A sua conta ainda não foi ativada pelo administrador, aguarde!');top.location.href='../index.html';</script>";
	}
