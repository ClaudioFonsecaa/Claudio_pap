...
function checkDelete(){
    return confirm('Tem a certeza que pretende apagar o utilizador ?');
		...
		$result = mysqli_query($connection,"select * from alunos, utilizadores where alunos.utilizadores_idutilizador=utilizadores.idutilizador order by ano asc") or die("Error: ".mysqli_error($connection));
