...
?>
	...
	<html>
		...
		<div class="pagina">
		 ...
		 <form class="login-form" method="POST" action="apagarPropostaN.php?id=<?php echo $idProposta?>&vaga=<?php echo$vaga?>">
		...
		<?php 
			...
			echo "<script>top.location.href='apagarPropostaN2.php?id=$idProposta&vaga=$vaga';</script>";
		}
