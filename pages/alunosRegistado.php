...
function checkDelete(){
    return confirm('Tem a certeza que pretende apagar o utilizador ?');
		...
		$result = mysqli_query($connection,"select * from alunos, utilizadores where alunos.utilizadores_idutilizador=utilizadores.idutilizador order by registado asc") or die("Error: ".mysqli_error($connection));
...
<div class='tabela'>
				...
				echo "
					...
					echo "<td> <a href='ficheiro.php?id=".$dado['utilizadores_idutilizador']."&nome=".$dado['nome_proprio']."'>Ficheiro</a></td>";
					echo "<td>" . $ano . "</td>";
					...
					if($_SESSION['userLevel']==3){
						echo "<td> <a href='editarA.php?id=".$dado['idaluno']."'>Editar</a></td>";
